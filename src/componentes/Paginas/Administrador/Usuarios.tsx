                                    ...
                                    return (
                                        <div key={u.$id} className={`mb-5 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 ${i === data.datos.$values.length - 1 ? '' : ' border-b-2 border-b-[#F3F4F6]'}`}>
                                            ...
                                            <div className="mt-2 lg:mt-0">
                                                <p className="text-sm text-gray-500">Email</p>
                                                <p className="text-base font-medium text-gray-800 break-words truncate">{u.email}</p>
                                            </div>
                                            <div className="mb-2 flex flex-wrap items-center justify-center mt-2 lg:mt-0 lg:mb-0">
